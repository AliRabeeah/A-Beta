...
const styles = StyleSheet.create({
  ...
  headerCol: { alignItems: 'center', marginBottom: 20 },
  icon: { width: 56, height: 56, borderRadius: 14, marginBottom: 12 },
  appName: { fontSize: 22, fontWeight: '800', textAlign: 'center' },
  version: { fontSize: 12.5, marginTop: 4, textAlign: 'center' },
