...
export default function SideDrawer({ visible, onClose, navigation }) {
  ...
  const MENU_ITEMS = [
    ...
    { key: 'Tables', icon: 'apps-outline', label: t('tablesTitle') },
    { key: 'Journal', icon: 'book-outline', label: t('journalTitle') },
    ...
    { key: 'Insights', icon: 'bar-chart-outline', label: t('insightsTitle') },
